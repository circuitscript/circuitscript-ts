...
// at_component_expr_next:   'at' component_select_expr (Comma component_select_expr)*;

to_component_expr: To (component_select_expr (Comma component_select_expr)*);   // ID? is for orientation
// pin_select_expr_next:   'pin' INTEGER_VALUE (Comma INTEGER_VALUE)?;

at_to_multiple_expr: At component_select_expr To component_select_expr (Comma component_select_expr)* Colon NEWLINE INDENT (NEWLINE | at_to_multiple_line_expr) + DEDENT;
at_to_multiple_line_expr: pin_select_expr2 Colon at_to_multiple_line_expr_to_pin (Comma at_to_multiple_line_expr_to_pin)*;
