...
export const script20_ = new ScriptTest(
    ...
    [
        ...
        [ '/GND', '_COMP_1_0.port_2.COMP_1_signal_c', 1 ],
        [ '/GND', '_COMP_1_0.port_2.COMP_1_signal_c:0', 1 ],
        [ '/GND', '_COMP_1_0.res_1.COMP_1_2k', 2 ],
        [ '/NET_1', 'tmp', 5 ],
        [ '/NET_1', 'res_3.COMP_1_5k', 1 ],
        [ '/NET_1', '_COMP_1_0.port_1.COMP_1_signal_e', 1 ],
        [ '/NET_1', '_COMP_1_0.port_1.COMP_1_signal_e:0', 1 ],
        [ '/NET_1', '_COMP_1_0.res_0.COMP_1_1k', 2 ],
        [ '/NET_1', '_COMP_1_0.res_1.COMP_1_2k', 1 ],
        [ '/VCC', 'vcc', 1 ],
        [ '/VCC', 'vcc:0', 1 ],
        [ '/VCC', 'tmp', 1 ],
        [ '/VCC', '_COMP_1_0.port_0.COMP_1_signal_a', 1 ],
        [ '/VCC', '_COMP_1_0.port_0.COMP_1_signal_a:0', 1 ],
        [ '/VCC', '_COMP_1_0.res_0.COMP_1_1k', 1 ],
        [ '/input', 'label_0.COMP_1_input', 1 ],
        [ '/input', 'label_0.COMP_1_input:0', 1 ],
        [ '/input', 'tmp', 2 ],
        [ '/input', '_COMP_1_0.port_3.COMP_1_signal_b', 1 ],
        [ '/input', '_COMP_1_0.port_3.COMP_1_signal_b:0', 1 ],
        [ '/input', '_COMP_1_0.res_2.COMP_1_3k', 1 ],
        [ '/output', 'label_1.COMP_1_output', 1 ],
        [ '/output', 'label_1.COMP_1_output:0', 1 ],
        [ '/output', 'tmp', 4 ],
        [ '/output', '_COMP_1_0.port_4.COMP_1_signal_d', 1 ],
        [ '/output', '_COMP_1_0.port_4.COMP_1_signal_d:0', 1 ],
        [ '/output', '_COMP_1_0.res_2.COMP_1_3k', 2 ]
      ]
);